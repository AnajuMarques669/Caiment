...
import { getAvatarTask } from '@/services/api';
...
export default function AvatarProcessingPage() {
  ...
  useEffect(() => {
    const taskId = sessionStorage.getItem(
    ...
    const checkTask = async () => {
      try {
        const data = await getAvatarTask(taskId);
